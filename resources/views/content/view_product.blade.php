        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="d-flex flex-row-reverse">
                            <button onclick="location.href='{{ route('product.create') }}'" type="button" class="btn btn-sm btn-pill btn-outline-primary font-weight-bolder"><i class="mdi mdi-plus"></i> {{ __('Add Product') }}</button>
                        </div>
            </div>
            <div class="card-body">
                <div class="col-md-12">
